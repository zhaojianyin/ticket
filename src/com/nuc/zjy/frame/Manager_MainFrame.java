...
public class Manager_MainFrame extends JFrame implements ActionListener {
	...
	public Manager_MainFrame() {
		...
		label_name.setBounds(453, 50, 229, 15);
		...
		lblAdmin.setBounds(453, 109, 217, 15);
